...
This application will allow creating/removing/updating/fetching CONTACT items. Each CONTACT item can optionally have an attachment image. Each user only has access to CONTACT items that he/she has created.
...
* `name` (string) - name of a CONTACT item (e.g. "Change a light bulb")
* `dueDate` (string) - date and time by which an item should be completed
* `done` (boolean) - true if an item was completed, false otherwise
* `attachmentUrl` (string) (optional) - a URL pointing to an image attached to a CONTACT item
...
It receives an object that contains three fields that can be updated in a CONTACT item:
